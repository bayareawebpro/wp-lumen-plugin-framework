<h2>{{ esc_attr_e( '2 Columns Layout: static (px)', 'wp_admin_style' ) }} </h2>

<div class="wrap">

    <div id="icon-options-general" class="icon32"></div>
    <h1>{{ esc_attr_e( 'Heading', 'wp_admin_style' ) }} </h1>
